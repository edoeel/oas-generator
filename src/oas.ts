...
export type MediaTypeObject = ExcludeReferenceObject<OpenAPIV3.MediaTypeObject>;
...
export type RequestBodyObject = ExcludeReferenceObject<OpenAPIV3.RequestBodyObject>;
